function rr_combine(gender_value, disease_act_value, risk_act_all_value, disease_alc_value, risk_alc_all_value, 
     disease_bmi_value, risk_bmi_all_value, disease_fpg_value, risk_fpg_all_value, disease_ldl_value, 
     risk_ldl_all_value, disease_sbp_value, risk_sbp_all_value, disease_smk_value, risk_smk_all_value, 
     death_rate_value) {
    const gender = gender_value;
    const disease_act = disease_act_value;
    const risk_act_all = risk_act_all_value;
    const disease_alc = disease_alc_value;
    const risk_alc_all = risk_alc_all_value;
    const disease_bmi = disease_bmi_value;
    const risk_bmi_all = risk_bmi_all_value;
    const disease_fpg = disease_fpg_value;
    const risk_fpg_all = risk_fpg_all_value;
    const disease_ldl = disease_ldl_value;
    const risk_ldl_all = risk_ldl_all_value;
    const disease_sbp = disease_sbp_value;
    const risk_sbp_all = risk_sbp_all_value;
    const disease_smk = disease_smk_value;
    const risk_smk_all = risk_smk_all_value;
    const dr = death_rate_value;
