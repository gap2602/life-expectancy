function le() {
    ...
    const result = document.getElementById("result_life_expectancy");
    const dr = rr_combine();
    ...
    result.textContent = `Your Life Expectancy is ${life_exp}, ${nMx_adj}, ${nqx_adj}, ${npx_adj}, ${lx_adj}, ${ndx_adj}, ${nLx_adj}, ${nTx_adj}, ${ex_adj} years`;
